...
theme.addEventListener('click', () => {
    ...
    setTimeout(() => {
        if (toggleTheme.classList.contains('active')) {
            // Set new colors for dark mode
            root.style.setProperty('--primary-color', '#1b1b1b');
            root.style.setProperty('--secondary-color', '#2e2e2e');
            root.style.setProperty('--tertiary-color', '#595959');
            root.style.setProperty('--quaternary-color', '#bfbfbf');
        } else {
            // Set back to light mode colors
            root.style.setProperty('--primary-color', '#294c6b');
            root.style.setProperty('--secondary-color', '#5d778e');
            root.style.setProperty('--tertiary-color', '#8392a0');
            root.style.setProperty('--quaternary-color', '#d1dde3');
        }
    }, 700);
